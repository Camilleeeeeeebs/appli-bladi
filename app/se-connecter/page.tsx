      ...
      >
          ...
          <div className="relative z-10">
            ...
            >
              ...
              <h1 className="text-2xl font-bold text-white mb-2">
                Bienvenue sur <br />
                votre portail de voyage
              </h1>
              <p className="text-white/80 text-sm mb-4">Connectez-vous pour découvrir les merveilles de l'Algérie</p>
            </motion.div>
          </div>
        ...
        <div className="w-full md:w-7/12 p-6 flex items-center">
          <div className="w-full max-w-sm mx-auto">
            ...
            >
              <h2 className="text-xl font-bold text-[#2F3E46] mb-1">Connectez-vous</h2>
              <p className="text-gray-500 text-sm mb-5">Entrez vos identifiants pour accéder à votre compte</p>
              ...
              <form className="space-y-4">
                ...
                <div className="space-y-1">
                  <div className="flex items-center justify-between">
                    ...
                    <Link href="#" className="text-xs font-medium text-[#52796F] hover:text-[#354F52]">
                      Oublié?
                    </Link>
                  </div>
              ...
              <p className="mt-5 text-center text-xs text-gray-500">
                ...
                <Link href="/s-inscrire" className="font-medium text-[#52796F] hover:text-[#354F52] transition-colors">
                  Inscrivez-vous
                </Link>
              </p>
            </motion.div>
